...
<div data-testid="catalog-unavailable" class="card-3d p-10 text-center max-w-xl mx-auto">
    ...
    <a href="<?= e(whatsapp_link('Bonjour Dina Perles ! Je souhaite voir vos créations.')) ?>" target="_blank" rel="noopener" class="btn-pill btn-dark mt-6"><?= icon('message-circle', 16) ?> Écrire sur WhatsApp</a>
</div>
