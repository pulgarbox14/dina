...
$steps = [
    [
        '01', 'shopping-bag', '#7c3aed', 'Choisissez votre pièce',
    ...
    [
        '02', 'message-circle', '#ea580c', 'Commandez en ligne ou sur WhatsApp',
    ...
    [
        '03', 'truck', '#0ea5e9', 'Payez et recevez',
...
<section data-testid="order-steps-section" class="px-3 sm:px-5 py-8">
    <div class="rounded-[40px] bg-[var(--bg-elevated)] py-20 lg:py-28 px-6 lg:px-16">
        <div class="max-w-[1440px] mx-auto">
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                <?= App\View::partial('partials/section-heading', [
                    'eyebrow'   => 'Commander',
                    'titleHtml' => 'Votre pièce en trois étapes.',
                    ...
                    <li data-reveal style="--delay: <?= $i * 0.1 ?>s">
                        <div data-tilt class="tilt-card relative card-3d p-8 lg:p-10 h-full flex flex-col" data-testid="order-step-<?= $n ?>">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-display text-5xl text-[var(--line)] leading-none" aria-hidden="true"><?= $n ?></span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-2 mt-8">
                                <?php foreach ($tags as $tag): ?>
                                    <span class="inline-flex items-center gap-1.5 bg-[var(--bg-elevated)] rounded-full px-3 h-8 text-xs text-[var(--ink-2)]"><?= icon('check', 12) ?> <?= e($tag) ?></span>
                                <?php endforeach; ?>
                            </div>
