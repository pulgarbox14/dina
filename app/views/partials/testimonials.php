...
$card = static function (array $review, int $i): string {
    ...
    ob_start(); ?>
    <figure class="card-3d p-8 w-[300px] sm:w-[400px] shrink-0 flex flex-col justify-between min-h-[250px]">
        <div>
            ...
            <blockquote class="font-display text-lg sm:text-xl leading-snug font-normal mt-5">« <?= e($text) ?> »</blockquote>
        </div>
...
?>
<section data-testid="testimonials-section" class="py-32 overflow-hidden">
    ...
    <div class="reviews-band mt-16" data-testid="reviews-band">
