...
<div data-testid="order-success" class="pt-48 pb-32 px-6 max-w-2xl mx-auto text-center">
    <div class="h-16 w-16 rounded-full bg-[var(--ink)] text-[var(--pearl)] flex items-center justify-center mx-auto"><?= icon('check', 24) ?></div>
    <h1 class="font-display text-5xl mt-8">Merci, <?= e(explode(' ', $order['customer_name'])[0]) ?>.</h1>
