...
<div data-testid="artisane-page">
    <section data-testid="artisan-hero" class="relative pt-[100px] lg:pt-[120px] overflow-hidden bg-white">
        <div class="flex flex-col-reverse">
            <div class="relative w-full max-w-[1440px] mx-auto px-6 text-center mt-4 lg:mt-8">
            ...
            <div class="relative mt-0 h-[400px] sm:h-[520px] lg:h-[600px] w-full max-w-[1440px] mx-auto flex items-end justify-center">
    ...
    <section class="max-w-[1440px] mx-auto px-6 lg:px-12 pt-24 grid lg:grid-cols-12 gap-12">
    ...
    <section class="max-w-[1440px] mx-auto px-6 lg:px-12 py-28">
    ...
    <section class="max-w-[1440px] mx-auto px-6 lg:px-12 py-28 grid lg:grid-cols-3 gap-6">
